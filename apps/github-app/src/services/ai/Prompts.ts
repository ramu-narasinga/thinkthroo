/**
 * Template data interface for rendering prompts
 */
...
Task: Review new hunks for **important** issues only and respond with comments if necessary.
...
`
  ...
  renderSummarizeFileDiff(
    ...
    const normalizedData = {
      ...data,
      file_diff: data.file_diff || data.fileDiff || "",
    };
  ...
  renderComment(data: TemplateData): string {
    return this.render(this.comment, data);
  }
