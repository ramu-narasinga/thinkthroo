...
import { EditorBubbleItem, useEditor } from "@thinkthroo/editor";
...
const HIGHLIGHT_COLORS: BubbleColorMenuItem[] = [
  {
    name: "Default",
    color: "var(--tt-editor-highlight-default)",
  },
  {
    name: "Purple",
    color: "var(--tt-editor-highlight-purple)",
  },
  {
    name: "Red",
    color: "var(--tt-editor-highlight-red)",
  },
  {
    name: "Yellow",
    color: "var(--tt-editor-highlight-yellow)",
  },
  {
    name: "Blue",
    color: "var(--tt-editor-highlight-blue)",
  },
  {
    name: "Green",
    color: "var(--tt-editor-highlight-green)",
  },
  {
    name: "Orange",
    color: "var(--tt-editor-highlight-orange)",
  },
  {
    name: "Pink",
    color: "var(--tt-editor-highlight-pink)",
  },
  {
    name: "Gray",
    color: "var(--tt-editor-highlight-gray)",
  },
];
