...
CREATE POLICY "agent_task_artifacts_insert" ON "agent_task_artifacts" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK ((auth.uid() = "agent_task_artifacts"."user_id"));--> statement-breakpoint
