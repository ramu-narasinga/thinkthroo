                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-y-12 gap-x-6 lg:gap-x-16 mt-12">
                    ...
                    <div>
                        ...
                        <ul role="list" className="mt-6 space-y-4">
                            ...
                            <li>
                                <a
                                    href="https://app.thinkthroo.com/cli"
                                    target="_blank"
                                    className="text-gray-600 text-sm leading-5"
                                >
                                    CLI
                    ...
                    <div>
                        ...
                        <ul role="list" className="mt-6 space-y-4">
                            ...
                            <li>
                                <a href="https://www.youtube.com/@ramu-narasinga" className="text-gray-600 text-sm leading-5">
                                    Youtube
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="https://github.com/ramu-narasinga" className="text-gray-600 text-sm leading-5">
                                    Github
                                </a>
                            </li>
                        </ul>
